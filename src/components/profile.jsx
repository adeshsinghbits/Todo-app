...
const Profile = () => {
  ...
  return (
    <div className={`flex flex-col top-12 overflow-auto right-0 absolute  transition-all ml-4 mt-4 ${
      ...
      <div className="bg-gray-400 flex flex-wrap justify-between  shadow-md rounded-lg py-2 px-5  mx-5 items-center">
        <div className="flex items-center">
        {user.image ? (
          <img
            src={user.image}
            alt="User Profile"
            className="md:w-24 md:h-24 w-20 h-20 shadow-lg rounded-full object-cover"
          />
        ) : (
        ...
        <button
          ...
          className='active:scale-90 mx-auto'
        >
          <IoLogOut  size={30} />
          <p>Logout</p>
        </button>
